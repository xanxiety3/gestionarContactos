...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM contactosxusuarios WHERE ID = :id AND ID_usuario = :id_usuario";
    ...
    if ($contacto) {
        ...
        echo 
        "<script>
        alert('El contacto no se encontró o no tiene permitido el acceso');
...
<body>
    ...
    <form method="POST" action="editarContacto.php">
        ...
        <input type="submit" name="botonedit" value="Guardar Cambios">
    </form>
</body>
</html>
