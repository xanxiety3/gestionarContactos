...
//   die();
    ...
    $sql = "SELECT * FROM contactosxusuarios WHERE ID_usuario = :id_usuario ";
...
<body>
    ...
    <table>
        ...
        <?php
         ...
         include_once("conexion.php");
    if (empty($contactos) ){
        echo "<script>alert('AUN NO HAY CONTACTOS AGREGADOS, INTENTA AGREGAR UNO');</script>";
       }else{
    ...
    <br/>
    <a href="agregar_contactos.php">Agregar nuevo contacto<br></a>
    <a   href=  "index.php" name="btncerrar" >Cerrar sesion </a>
